...
from filling_scheduler.enums import ErrorCode, EventName, ExitCode, StageName, TimingMode
...
def solve_command(args, run_id: str, log_file: Path) -> dict:
    ...
    timing_mode = args.timing_mode or TimingMode.HEURISTIC
    ...
    metrics["settings"]["decomposition"] = args.decomposition
    if args.decomposition:
    ...
    response = {"status": result.status, "timing_mode": timing_mode, "decomposition": args.decomposition, "proven_objectives": metrics["proven_objectives"],
